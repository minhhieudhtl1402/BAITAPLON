...
<head>
    ...
    <link rel="stylesheet" href=".././assets/css/reponsivebtl.css">
                ...
                <div class="col-md-12 ">
                    <div class="btn-group" role="group">
                        ...
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://www.flickr.com/about" class="footer_txt" > About</a>
                        </button>
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://www.flickr.com/jobs" class="footer_txt">Jobs</a>
                          
                        </button>
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://blog.flickr.net/en" class="footer_txt">Blog</a>
                        </button>
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://www.flickr.com/services/developer"class="footer_txt">Deverlopers</a>
                        </button>
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://www.flickr.com/help/guidelines"class="footer_txt">Guidelines</a>
                        </button>
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://www.flickrhelp.com/hc/en-us" class="footer_txt">Help</a>
                        </button>
                        <button class="btn btn-secondary mausac nav-item" type="button">
                            <a href="https://www.flickr.com/help/forum/en-us/" class="footer_txt">Help forum</a>
                        </button>
                        <button class="btn btn-secondary mausac1 nav-item" type="button">
                            <a href="https://www.flickr.com/help/privacy" class="footer_txt1">Privacy</a>
                        </button>
                        <button class="btn btn-secondary mausac1 nav-item" type="button">
                            <a href="https://www.flickr.com/help/terms" class="footer_txt1"> Terms</a>
                        </button>
                        <button class="btn btn-secondary mausac1 nav-item" type="button">
                            <a href="https://www.flickr.com/help/cookies" class="footer_txt1">Cookies</a>
                        </button>
                        <button class="btn btn-secondary mausac1 nav-item" type="button">
                            <a class="nav-link dropdown-toggle footer_txt1" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: white;" >  
                                English
                              </a>
                        ...
                        <button class="btn btn-secondary mausaca" type="button">
                        ...
                        <button class="btn btn-secondary mausac" type="button">
                           <a href="https://www.facebook.com/flickr" style="color: white;"> <i class="bi bi-facebook footer_icon" ></i></a>
                        </button>
                        <button class="btn btn-secondary mausac" type="button">
                           <a href="https://twitter.com/flickr" style="color: white;"> <i class="bi bi-twitter footer_icon" ></i></a>
                        </button>
                        <button class="btn btn-secondary mausac" type="button">
                          <a href="https://www.instagram.com/flickr/" style="color: white; ;"> <i class="bi bi-instagram footer_icon" ></i></a>
                        </button>
                    </div>
                </div>
            </div>
