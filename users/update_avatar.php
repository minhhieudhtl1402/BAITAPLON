...
<body>
    ...
    <div class="container-fluid   main-up">
        ...
        <div class="row ">
            ...
            <div class="col-md-4 ">
                <form role="form " style="margin-top: 250px;" action="process_update_avatar.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="formFileMultiple" class="form-label fs-3 text-white">Choose Avatar Image</label>
                        <input name="file" class="form-control" type="file" multiple>
                    </div <!-- <input class="form-control form-control-lg" type="text" placeholder="Title Image" aria-label=".form-control-lg example" name="title"> -->
